...
public class Q1 extends javax.swing.JFrame {
    ...
    String[][] options = {
        {"Adele Goldberg", "Dennis Ritchie", "Alan Kay", "Andrea Ferro", "Alan Kay"},
        {"Encapsulation", "Polymorphism", "Exception", "Abstraction", "Exception"},
        {"Abstraction", "Encapsulation", "Polymorphism", "Inheritance", "Inheritance"},
        {"C++ programming language", "Java programming language", "Ada programming language", "C# programming language", "Ada programming language"},
        {"Inheritance", "Data hiding", "Encapsulation", "Polymorphism", "Inheritance"}
    };
