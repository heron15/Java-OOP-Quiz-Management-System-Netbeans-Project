...
public class Q4 extends javax.swing.JFrame {
    ...
    String[] question = {
        ...
        "Which among the following is correct about B group Vitamins?",
        "Kwashiorkor disease is caused by the deficiency of which of the following ?",
        "To which organ of the body is the disease 'Glaucoma' related to?"
    };

    String[][] options = {
        {"Sulphates", "Chlorides", "Carbonates", "Nitrates", "Nitrates"},
        {"Brain", "Bones", "Skin", "Liver", "Brain"},
        {"Most of them are organic acids", "Most of them are water soluble", "Most of them are synthesized in the body", "All are correct", "Most of them are water soluble"},
        {"Vitamins", "Proteins", "Fats", "Minerals", "Proteins"},
        {"Ear", "Heart", "Bones", "Eye", "Eye"}
    };
